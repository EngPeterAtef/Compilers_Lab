...
class NFA_CLASS:
    ...
    def construct_nfa(self, node):
        ...
        elif isinstance(node, LiteralCharacterAstNode) or isinstance(node, CharacterClassAstNode):
    ...
    def construct_or_nfa(self, node):
        ...
        start_transition_2 = Edge(from_=start, to_=right_nfa.start, characters={EPSILON})
        
        # Link the accept state with both the accept of A's NFA and B's NFA with an epsilon transitions
        final_transition_1 = Edge(from_=left_nfa.accept, to_=accept, characters={EPSILON})
        final_transition_2 = Edge(from_=right_nfa.accept, to_=accept, characters={EPSILON})
        ...
        transitions = [
            ...
            *right_nfa.transitions,
            start_transition_1, start_transition_2,
            final_transition_1, final_transition_2
        ]
    ...
    def construct_seq_nfa(self, node):
        ...
        final_transition = Edge(from_=left_nfa.accept, to_=right_nfa.start, characters={EPSILON})
    ...
    def construct_star_plus_nfa(self, node):
        ...
        final_transition_2 = Edge(from_=left_nfa.accept, to_=start, characters={EPSILON})
